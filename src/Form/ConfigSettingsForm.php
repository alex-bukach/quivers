...
class ConfigSettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['profile_configuration']['client_id'] = [
      ...
      '#required' => TRUE,
      '#description' => $this->t('Client ID generated by creating OAuth2 Consumer'),
    ];
    $form['profile_configuration']['client_secret'] = [
      ...
      '#required' => TRUE,
      '#description' => $this->t('Client Secret generated by creating OAuth2 Consumer'),
    ];
    $form['profile_configuration']['refresh_token'] = [
      ...
      '#required' => TRUE,
      '#maxlength' => 1024,
      '#description' => $this->t('Refresh Token generated by making a POST request to /oauth/token'),
    ];
