...
namespace Drupal\quivers_drupal_plugin\PluginForm\Stripe;
...
class PaymentMethodAddForm extends BasePaymentMethodAddForm {
  ...
  public function buildCreditCardForm(array $element, FormStateInterface $form_state) {
    ...
    /** @var \Drupal\quivers_drupal_plugin\Plugin\Commerce\PaymentGateway\StripeInterface $plugin */
    $plugin = $this->plugin;
    $element['#attached']['library'][] = 'quivers_drupal_plugin/form';
